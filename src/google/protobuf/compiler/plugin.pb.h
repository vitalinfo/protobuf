...
class PROTOC_EXPORT Version final :
 ...
 public:
  ...
  void set_suffix(Arg&& arg, Args... args);
...
class PROTOC_EXPORT CodeGeneratorRequest final :
 ...
 public:
  ...
  template <typename Arg = const std::string, typename... Args>
  void set_parameter(Arg&& arg, Args... args);
...
class PROTOC_EXPORT CodeGeneratorResponse_File final :
 ...
 public:
  ...
  template <typename Arg = const std::string, typename... Args>
  void set_insertion_point(Arg&& arg, Args... args);
  ...
  template <typename Arg = const std::string, typename... Args>
  void set_content(Arg&& arg, Args... args);
...
class PROTOC_EXPORT CodeGeneratorResponse final :
 ...
 public:
  ...
  template <typename Arg = const std::string, typename... Args>
  void set_error(Arg&& arg, Args... args);
...
inline PROTOBUF_ALWAYS_INLINE void Version::set_suffix(Arg&& arg,
                                                     Args... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.suffix_.Set(static_cast<Arg&&>(arg), args..., GetArenaForAllocation());
...
template <typename Arg, typename... Args>
inline PROTOBUF_ALWAYS_INLINE void CodeGeneratorRequest::set_parameter(Arg&& arg,
                                                     Args... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.parameter_.Set(static_cast<Arg&&>(arg), args..., GetArenaForAllocation());
...
template <typename Arg, typename... Args>
inline PROTOBUF_ALWAYS_INLINE void CodeGeneratorResponse_File::set_name(Arg&& arg,
                                                     Args... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
...
template <typename Arg, typename... Args>
inline PROTOBUF_ALWAYS_INLINE void CodeGeneratorResponse_File::set_insertion_point(Arg&& arg,
                                                     Args... args) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.insertion_point_.Set(static_cast<Arg&&>(arg), args..., GetArenaForAllocation());
...
template <typename Arg, typename... Args>
inline PROTOBUF_ALWAYS_INLINE void CodeGeneratorResponse_File::set_content(Arg&& arg,
                                                     Args... args) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.content_.Set(static_cast<Arg&&>(arg), args..., GetArenaForAllocation());
...
template <typename Arg, typename... Args>
inline PROTOBUF_ALWAYS_INLINE void CodeGeneratorResponse::set_error(Arg&& arg,
                                                     Args... args) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.error_.Set(static_cast<Arg&&>(arg), args..., GetArenaForAllocation());
